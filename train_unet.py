...
def progresscallback_img2img(epoch, logs, model, history, fig, generatorV):
    ...
    savename_dataX = "./data_samples/"+train_para["para_name"]+"_@epoch"+str(epoch)+"_dataX.npy"
    savename_dataY = "./data_samples/"+train_para["para_name"]+"_@epoch"+str(epoch)+"_dataY.npy"
    savename_predY = "./data_samples/"+train_para["para_name"]+"_@epoch"+str(epoch)+"_predY.npy"
    print("Save as ", savename_dataX, savename_dataY, savename_predY)
    np.save(savename_dataX, dataX)
    np.save(savename_dataY, dataY)
    np.save(savename_predY, predY)
